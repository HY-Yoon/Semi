    ...
    <main>
    	<div class="container">
    		...
    		<section class="content_section">
    			<jsp:include page="/html&jsp/board_chat/chatManage.jsp"/>
    		</section>
    	</div>
    </main>
    <footer>
        <jsp:include page="/html&jsp/default/default_footer.jsp"/>
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/board_chat/chatmanage.css?ver=<%=System.currentTimeMillis()%>">
    </footer>
</body>
