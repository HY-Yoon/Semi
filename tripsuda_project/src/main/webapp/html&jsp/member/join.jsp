...
<body>
	...
	<div id="warp">
		...
		<div>
			...
			<input type="tel" name="nick" id="mobile" class="int" maxlength="11" placeholder="전화번호 입력">
			</span> <span class="error_next_box"></span>
		</div>
		...
		<div>
			...
			<div id="bir_wrap">
				...
				<div id="bir_yy">
					<span class="box"> 
					<input type="text" name="birth_yy" id="birth_yy" class="int" maxlength="4" placeholder="년(4자)">
					</span>
				</div>

				<!-- BIRTH_MM -->
				<div id="bir_mm">
					<span class="box"> <select name="birth_mm" id="birth_mm" class="sel">
							<option>월</option>
				...
				<div id="bir_dd">
					<span class="box"> 
					<input type="text" name="birth_dd" id="birth_dd" class="int" maxlength="2" placeholder="일">
					</span>
				</div>
			</div>
			<span class="error_next_box"></span>
		...
		<div class="btn_area">
			...
			<input type="reset" id="joincancel" value="취소">
			</button>
		</div>
	</div>
</body>
